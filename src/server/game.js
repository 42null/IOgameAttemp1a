...
class Game {
  constructor() {
    ...
    this.astroids = this.astroids.concat(Generator.generateAttackables(Astroid, 10,10,100));
  }
  ...
  update() {
    ...
    this.astroids = this.astroids.concat(Generator.generateAttackables(Astroid, destroyedAstroids.length,10,100));
...
//     // this.astroids = this.astroids.concat(Generator.generateAttackables(Astroid, Constants.MAP_SIZE/150,10,100));
//    this.astroids = this.astroids.concat(Generator.generateAttackables(Astroid, 10,10,100)); 
//   }
